...
export const ukLocations: LocationData[] = [
  ...
  },
  {
    ...
    cityDescription: "Manchester has transformed from its industrial heritage into a modern hub of commerce, creativity, and technology. Home to two Premier League football clubs, a thriving food scene, and a rapidly growing tech sector, Manchester businesses operate in one of the UK's most dynamic markets. AIVized helps Manchester companies compete at the highest level with intelligent automation that delivers outstanding customer experiences.",
    faqs: [
