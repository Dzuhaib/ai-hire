...
const industryConfigs: IndustryCityConfig[] = [
  ...
  },
  {
    ...
    faqTemplates: [
      ...
      { q: "How much does a healthcare AI chatbot cost in {city}?", a: "From just £29/month, a fraction of the cost of hiring reception staff. Our {city} healthcare chatbot captures 35% more new patient registrations on average." },
    ],
  },
  {
    industrySlug: "legal",
  ...
  },
  {
    ...
    faqTemplates: [
      ...
      { q: "How much does a travel agent AI chatbot cost in {city}?", a: "From just £29/month. Capture evening and weekend holiday browsers before they default to online booking platforms and triple your {city} evening leads." },
