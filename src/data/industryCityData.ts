...
const industryConfigs: IndustryCityConfig[] = [
  {
    ...
    metaTitleTemplate: "AI Chatbot for Restaurants in {city} | Managed from £29/mo | AIVized",
  ...
  },
  {
    ...
    metaTitleTemplate: "AI Chatbot for Real Estate in {city} | Managed from £29/mo | AIVized",
  ...
  },
  {
    ...
    metaTitleTemplate: "AI Chatbot for E-Commerce in {city} | Managed from £29/mo | AIVized",
  ...
  },
  {
    ...
    metaTitleTemplate: "AI Chatbot for Healthcare in {city} | Managed from £29/mo | AIVized",
  ...
  },
  {
    ...
    metaTitleTemplate: "AI Chatbot for Law Firms in {city} | Managed from £29/mo | AIVized",
  ...
  },
  {
    ...
    metaTitleTemplate: "AI Chatbot for Gyms & Fitness in {city} | Managed from £29/mo | AIVized",
  ...
  },
  {
    ...
    metaTitleTemplate: "AI Chatbot for Travel Agents in {city} | Managed from £29/mo | AIVized",
