  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <PageMeta
        ...
        canonical={`https://www.aivized.com/industries/${industry.slug}`}
            ...
            >
              <div className="relative">
                ...
                <div className="relative rounded-3xl overflow-hidden border border-primary/20 bg-card/30 backdrop-blur-sm shadow-2xl">
                  <img src={heroImage} alt={`AI assistant for ${industry.industry}`} className="w-full max-w-md object-cover" loading="eager" />
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative order-2 lg:order-1">
              <div className="relative">
                ...
                <div className="relative rounded-2xl overflow-hidden border border-primary/20 shadow-xl">
                  <img src={sceneImage} alt={`AI assistant working in ${industry.industry}`} className="w-full object-cover" loading="lazy" />
          ...
          <div className="container-narrow">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {industryCities.map(c => (
                <Link
                  key={c.citySlug}
                  to={`/industries/${industrySlug}/${c.citySlug}`}
        ...
        <div className="container-narrow">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            {allIndustries
              ...
              .map((ind) => (
                <Link key={ind.slug} to={`/industries/${ind.slug}`} className="group p-6 rounded-xl bg-card border border-border/50 hover:border-primary/50 hover:bg-primary/5 transition-all">
