            ...
            <div className="prose prose-invert max-w-none space-y-8">
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  By accessing or using RentlizedAI's services, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using our services.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  RentlizedAI provides AI-powered customer service automation solutions for UK businesses. Our platform includes chatbot services, analytics, and integration capabilities designed to enhance your customer engagement.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  All content, features, and functionality of our services are owned by RentlizedAI and protected by UK and international copyright, trademark, and other intellectual property laws. You may not reproduce, distribute, or create derivative works without our express written consent.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  To the maximum extent permitted by law, RentlizedAI shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our services. Our total liability shall not exceed the amount paid by you in the 12 months preceding the claim.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mt-4">
                  <strong>Email:</strong> legal@rentlizedai.com<br />
                  <strong>Address:</strong> RentlizedAI, United Kingdom
                </p>
              </section>
            </div>
          </motion.div>
