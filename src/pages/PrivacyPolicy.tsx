            ...
            <div className="prose prose-invert max-w-none space-y-8">
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  RentlizedAI ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our AI-powered customer service platform and related services.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mt-4">
                  <strong>Email:</strong> privacy@rentlizedai.com<br />
