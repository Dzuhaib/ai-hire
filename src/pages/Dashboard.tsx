                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <div className="flex flex-wrap gap-3 mt-3">
                                  ...
                                  <Link to="/#pricing" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-border hover:bg-secondary text-sm font-medium transition-colors">
                                    Choose a New Plan
                                  </Link>
                                </div>
                              </div>
