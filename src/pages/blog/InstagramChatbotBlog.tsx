...
import instagramInline1 from "@/assets/blog/instagram-inline-1.png";
import instagramInline2 from "@/assets/blog/instagram-inline-2.png";
import instagramInline3 from "@/assets/blog/instagram-inline-3.png";
...
const InstagramChatbotBlog = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <article className="container-narrow">
          ...
          <motion.header initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-12">
            ...
            <div className="rounded-2xl overflow-hidden aspect-video bg-secondary">
              <img src={instagramHero} alt="Instagram Chatbot for UK Business" className="w-full h-full object-cover" />
            </div>
          </motion.header>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }} className="mt-16 p-8 md:p-12 rounded-2xl bg-gradient-to-br from-pink-500/10 to-purple-500/10 border border-pink-500/20 text-center">
      ...
      <RelatedPagesSection currentPage="blog" currentSlug="instagram-chatbot-social-media" title="Related Resources" subtitle="Explore more AI chatbot solutions for UK businesses" />
      <Footer />
    </div>
  );
};
