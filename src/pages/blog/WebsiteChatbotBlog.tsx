...
import websiteInline1 from "@/assets/blog/website-inline-1.png";
import websiteInline2 from "@/assets/blog/website-inline-2.png";
import websiteInline3 from "@/assets/blog/website-inline-3.png";
      ...
      <main className="pt-32 pb-20">
        <article className="container-narrow">
          ...
          <motion.header initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-12">
            <span className="inline-block px-4 py-2 rounded-full bg-blue-500/10 text-blue-500 text-sm font-medium mb-6">Website</span>
            ...
            <div className="rounded-2xl overflow-hidden aspect-video bg-secondary">
              <img src={websiteHero} alt="Website Chatbot for UK Business" className="w-full h-full object-cover" />
            </div>
          </motion.header>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <div className="not-prose my-8 p-6 rounded-lg bg-blue-500/10 border border-blue-500/20">
              ...
              <p className="text-muted-foreground">UK businesses that implement website chatbots see an average 35% increase in lead capture and a 40% reduction in response times.</p>
            </div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }} className="mt-16 p-8 md:p-12 rounded-2xl bg-gradient-to-br from-blue-500/10 to-indigo-500/10 border border-blue-500/20 text-center">
            ...
            <Link to="/pricing" className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity">View Pricing</Link>
          </motion.div>
        </article>
      </main>
      
      <RelatedPagesSection currentPage="blog" currentSlug="website-chatbot-small-business" title="Related Resources" subtitle="Explore more AI chatbot solutions for UK businesses" />
      <Footer />
    </div>
  );
};
