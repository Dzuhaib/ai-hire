          ...
          >
            ...
            <div className="prose prose-invert max-w-none space-y-8">
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                  <li><strong>How to Cancel:</strong> Through your account dashboard or by contacting info@aivized.com</li>
              ...
              <section>
                ...
                <ol className="list-decimal list-inside text-muted-foreground space-y-2 ml-4">
                  <li><strong>Contact Us:</strong> Email info@aivized.com with the subject line "Refund Request"</li>
              ...
              <section>
                ...
                <p className="text-muted-foreground mt-4">
                  ...
                  <strong>Email:</strong> info@aivized.com<br />
                  <strong>Billing Enquiries:</strong> info@aivized.com<br />
