...
const heroImage = "/assets/blog/reduce-missed-leads-hero.png";
const reduceInline1 = "/assets/blog/reduce-leads-inline-1.png";
const reduceInline2 = "/assets/blog/reduce-leads-inline-2.png";
const reduceInline3 = "/assets/blog/reduce-leads-inline-3.png";
      ...
      <main className="pt-32 pb-20">
        <article className="container-narrow">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <ul>
              <li>A potential customer visits your <Link href="/industries/restaurant" className="text-primary hover:underline">restaurant</Link> website at 9pm to ask about group booking availability. Your phone line is closed. They book elsewhere.</li>
              <li>A homeowner browses your <Link href="/industries/real-estate" className="text-primary hover:underline">estate agency</Link> site on a Sunday afternoon, wondering about a property. No one responds until Monday. They've already contacted three other agents.</li>
            ...
            <ol>
              ...
              <li><strong>Choose a managed AI chatbot:</strong> Don't waste time building your own. A <Link href="/#how-it-works" className="text-primary hover:underline">managed service</Link> like AIVized handles everything for you.</li>
