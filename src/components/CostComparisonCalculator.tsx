    ...
    <section className="py-16 md:py-24">
      ...
      <div className="container-narrow">
        ...
        <motion.div
          ...
          className="bg-card border border-border rounded-xl p-6 md:p-8 lg:p-10"
        >
          {/* Plan Selector */}
          <div className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 lg:gap-6 mb-10">
            {/* AIVized */}
            <div className="relative p-6 rounded-xl bg-primary/6 border border-primary/25">
          ...
          {/* Savings Summary */}
          <div className="bg-secondary/40 rounded-xl p-6 md:p-8 border border-border/60">
