      ...
      <div className="container-narrow relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {industries.map((industry, index) => (
            ...
            >
              <div className="relative h-full p-8 rounded-3xl bg-card/50 border border-border/50 overflow-hidden transition-all duration-300 hover:border-primary/30 hover:shadow-xl">
