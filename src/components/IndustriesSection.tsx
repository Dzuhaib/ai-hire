...
const industries = [
  {
    title: "Restaurants",
    description: "Handle bookings, answer menu queries, and take orders automatically.",
    icon: (
  ...
  {
    title: "Real Estate",
    description: "Qualify leads, schedule viewings, and answer property questions 24/7.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: "E-commerce",
    description: "Support customers, track orders, and boost conversions instantly.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="container-narrow">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {industries.map((industry, index) => (
            ...
            >
              <MagneticButton
                className="card-premium p-8 w-full text-left group cursor-pointer"
